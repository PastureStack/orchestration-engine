...
[`v0.183.319`](https://github.com/PastureStack/orchestration-engine/releases/tag/v0.183.319)
produces engine version `0.183.319`. It retains the existing Java 25, Ubuntu
...
```sh
ENGINE_VERSION=0.183.319 bash scripts/build --release
