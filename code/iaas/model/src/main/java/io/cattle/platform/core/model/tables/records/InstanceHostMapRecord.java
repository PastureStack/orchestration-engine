...
@Entity
@Table(
    name = "instance_host_map",
    schema = "cattle",
    uniqueConstraints = {
        @UniqueConstraint(name = "KEY_instance_host_map_idx_instance_host_map_uuid", columnNames = { "uuid" })
    },
    indexes = {
        @Index(name = "idx_instance_host_map_name", columnList = "name ASC"),
        @Index(name = "idx_instance_host_map_remove_time", columnList = "remove_time ASC"),
        @Index(name = "idx_instance_host_map_removed", columnList = "removed ASC"),
        @Index(name = "idx_instance_host_map_state", columnList = "state ASC")
    }
)
public class InstanceHostMapRecord extends UpdatableRecordImpl<InstanceHostMapRecord> implements TableRecordJaxb, InstanceHostMap {
    ...
    public Map<String,Object> getData() {
        return get(InstanceHostMapTable.INSTANCE_HOST_MAP.DATA);
    }
    ...
    public Record1<Long> key() {
        return super.key().into(InstanceHostMapTable.INSTANCE_HOST_MAP.ID);
    }
