...
public class VolumeStoragePoolMapRecord extends UpdatableRecordImpl<VolumeStoragePoolMapRecord> implements TableRecordJaxb, VolumeStoragePoolMap {
    ...
    public Map<String,Object> getData() {
        return get(VolumeStoragePoolMapTable.VOLUME_STORAGE_POOL_MAP.DATA);
    }
    ...
    public Record1<Long> key() {
        return super.key().into(VolumeStoragePoolMapTable.VOLUME_STORAGE_POOL_MAP.ID);
    }
