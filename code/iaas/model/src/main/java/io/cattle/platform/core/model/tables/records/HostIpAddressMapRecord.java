...
@Entity
@Table(
    name = "host_ip_address_map",
    schema = "cattle",
    uniqueConstraints = {
        @UniqueConstraint(name = "KEY_host_ip_address_map_idx_host_ip_address_map_uuid", columnNames = { "uuid" })
    },
    indexes = {
        @Index(name = "idx_host_ip_address_map_name", columnList = "name ASC"),
        @Index(name = "idx_host_ip_address_map_remove_time", columnList = "remove_time ASC"),
        @Index(name = "idx_host_ip_address_map_removed", columnList = "removed ASC"),
        @Index(name = "idx_host_ip_address_map_state", columnList = "state ASC")
    }
)
public class HostIpAddressMapRecord extends UpdatableRecordImpl<HostIpAddressMapRecord> implements TableRecordJaxb, HostIpAddressMap {
    ...
    public Map<String,Object> getData() {
        return get(HostIpAddressMapTable.HOST_IP_ADDRESS_MAP.DATA);
    }
    ...
    public Record1<Long> key() {
        return super.key().into(HostIpAddressMapTable.HOST_IP_ADDRESS_MAP.ID);
    }
    ...
    @Override
    public void from(HostIpAddressMap from) {
        setId(from.getId());
    ...
    @Override
    public <E extends HostIpAddressMap> E into(E into) {
        into.from(this);
        return into;
    }
    ...
    public HostIpAddressMapRecord() {
        super(HostIpAddressMapTable.HOST_IP_ADDRESS_MAP);
    }

    /**
     * Create a detached, initialised HostIpAddressMapRecord
     */
    public HostIpAddressMapRecord(Long id, String name, String kind, String uuid, String description, String state, Date created, Date removed, Date removeTime, Map<String,Object> data, Long hostId, Long ipAddressId) {
        super(HostIpAddressMapTable.HOST_IP_ADDRESS_MAP);
