...
public class GenericObjectRecord extends UpdatableRecordImpl<GenericObjectRecord> implements TableRecordJaxb, GenericObject {
    ...
    public Map<String,Object> getData() {
        return get(GenericObjectTable.GENERIC_OBJECT.DATA);
    }
    ...
    public Record1<Long> key() {
        return super.key().into(GenericObjectTable.GENERIC_OBJECT.ID);
    }
