...
public class HealthcheckInstanceRecord extends UpdatableRecordImpl<HealthcheckInstanceRecord> implements TableRecordJaxb, HealthcheckInstance {
    ...
    public Map<String,Object> getData() {
        return get(HealthcheckInstanceTable.HEALTHCHECK_INSTANCE.DATA);
    }
    ...
    public Record1<Long> key() {
        return super.key().into(HealthcheckInstanceTable.HEALTHCHECK_INSTANCE.ID);
    }
