...
public class ServiceIndexRecord extends UpdatableRecordImpl<ServiceIndexRecord> implements TableRecordJaxb, ServiceIndex {
    ...
    public Map<String,Object> getData() {
        return get(ServiceIndexTable.SERVICE_INDEX.DATA);
    }
    ...
    public Record1<Long> key() {
        return super.key().into(ServiceIndexTable.SERVICE_INDEX.ID);
    }
    ...
    public ServiceIndexRecord(Long id, String name, Long accountId, String kind, String uuid, String description, String state, Date created, Date removed, Date removeTime, Map<String,Object> data, String serviceIndex, String launchConfigName, Long serviceId, String address) {
        ...
        setLaunchConfigName(launchConfigName);
