...
public class ProjectMemberRecord extends UpdatableRecordImpl<ProjectMemberRecord> implements TableRecordJaxb, ProjectMember {
    ...
    public Map<String,Object> getData() {
        return get(ProjectMemberTable.PROJECT_MEMBER.DATA);
    }
    ...
    public Record1<Long> key() {
        return super.key().into(ProjectMemberTable.PROJECT_MEMBER.ID);
    }
