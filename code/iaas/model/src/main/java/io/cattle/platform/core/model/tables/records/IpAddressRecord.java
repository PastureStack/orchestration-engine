...
public class IpAddressRecord extends UpdatableRecordImpl<IpAddressRecord> implements TableRecordJaxb, IpAddress {
    ...
    public Map<String,Object> getData() {
        return get(IpAddressTable.IP_ADDRESS.DATA);
    }
    ...
    public Record1<Long> key() {
        return super.key().into(IpAddressTable.IP_ADDRESS.ID);
    }
