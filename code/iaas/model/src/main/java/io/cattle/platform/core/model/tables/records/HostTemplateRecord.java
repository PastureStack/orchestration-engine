...
public class HostTemplateRecord extends UpdatableRecordImpl<HostTemplateRecord> implements TableRecordJaxb, HostTemplate {
    ...
    public Map<String,Object> getData() {
        return get(HostTemplateTable.HOST_TEMPLATE.DATA);
    }
    ...
    public Record1<Long> key() {
        return super.key().into(HostTemplateTable.HOST_TEMPLATE.ID);
    }
