...
@Table(
    ...
    schema = "cattle",
    uniqueConstraints = {
        @UniqueConstraint(name = "KEY_network_driver_idx_network_driver_uuid", columnNames = { "uuid" })
    },
    indexes = {
        @Index(name = "idx_network_driver_name", columnList = "name ASC"),
        @Index(name = "idx_network_driver_remove_time", columnList = "remove_time ASC"),
        @Index(name = "idx_network_driver_removed", columnList = "removed ASC"),
        @Index(name = "idx_network_driver_state", columnList = "state ASC")
    }
)
public class NetworkDriverRecord extends UpdatableRecordImpl<NetworkDriverRecord> implements TableRecordJaxb, NetworkDriver {
    ...
    public Map<String,Object> getData() {
        return get(NetworkDriverTable.NETWORK_DRIVER.DATA);
    }
    ...
    public Record1<Long> key() {
        return super.key().into(NetworkDriverTable.NETWORK_DRIVER.ID);
    }
