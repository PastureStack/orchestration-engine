...
public class DeploymentUnitRecord extends UpdatableRecordImpl<DeploymentUnitRecord> implements TableRecordJaxb, DeploymentUnit {
    ...
    public Map<String,Object> getData() {
        return get(DeploymentUnitTable.DEPLOYMENT_UNIT.DATA);
    }
    ...
    public Record1<Long> key() {
        return super.key().into(DeploymentUnitTable.DEPLOYMENT_UNIT.ID);
    }
     ...
     */
    public DeploymentUnitRecord(Long id, String name, Long accountId, String kind, String uuid, String description, String state, Date created, Date removed, Date removeTime, Map<String,Object> data, String serviceIndex, Long serviceId) {
        super(DeploymentUnitTable.DEPLOYMENT_UNIT);
