...
@Entity
@Table(
    name = "service_consume_map",
    schema = "cattle",
    uniqueConstraints = {
        @UniqueConstraint(name = "KEY_service_consume_map_idx_service_consume_map_uuid", columnNames = { "uuid" })
    },
    indexes = {
        @Index(name = "idx_service_consume_map_name", columnList = "name ASC"),
        @Index(name = "idx_service_consume_map_remove_time", columnList = "remove_time ASC"),
        @Index(name = "idx_service_consume_map_removed", columnList = "removed ASC"),
        @Index(name = "idx_service_consume_map_state", columnList = "state ASC")
    }
)
public class ServiceConsumeMapRecord extends UpdatableRecordImpl<ServiceConsumeMapRecord> implements TableRecordJaxb, ServiceConsumeMap {
    ...
    public Map<String,Object> getData() {
        return get(ServiceConsumeMapTable.SERVICE_CONSUME_MAP.DATA);
    }
     ...
     */
    @Column(name = "consumed_service_id")
    @Override
     ...
     */
    @Column(name = "consumed_service", length = 255)
    @Override
    ...
    public Record1<Long> key() {
        return super.key().into(ServiceConsumeMapTable.SERVICE_CONSUME_MAP.ID);
    }
     ...
     */
    public ServiceConsumeMapRecord(Long id, String name, String kind, String uuid, String description, String state, Date created, Date removed, Date removeTime, Map<String,Object> data, Long serviceId, Long consumedServiceId, Long accountId, String consumedService) {
        super(ServiceConsumeMapTable.SERVICE_CONSUME_MAP);
        ...
        setConsumedServiceId(consumedServiceId);
        setAccountId(accountId);
        setConsumedService(consumedService);
        resetTouchedOnNotNull();
    }
}
