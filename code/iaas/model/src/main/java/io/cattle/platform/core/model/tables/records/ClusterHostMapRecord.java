...
@Table(
    ...
    schema = "cattle",
    uniqueConstraints = {
        @UniqueConstraint(name = "KEY_cluster_host_map_idx_cluster_host_map_uuid", columnNames = { "uuid" })
    },
    indexes = {
        @Index(name = "idx_cluster_host_map_name", columnList = "name ASC"),
        @Index(name = "idx_cluster_host_map_remove_time", columnList = "remove_time ASC"),
        @Index(name = "idx_cluster_host_map_removed", columnList = "removed ASC"),
        @Index(name = "idx_cluster_host_map_state", columnList = "state ASC")
    }
)
public class ClusterHostMapRecord extends UpdatableRecordImpl<ClusterHostMapRecord> implements TableRecordJaxb, ClusterHostMap {
    ...
    public Map<String,Object> getData() {
        return get(ClusterHostMapTable.CLUSTER_HOST_MAP.DATA);
    }
    ...
    public Record1<Long> key() {
        return super.key().into(ClusterHostMapTable.CLUSTER_HOST_MAP.ID);
    }
