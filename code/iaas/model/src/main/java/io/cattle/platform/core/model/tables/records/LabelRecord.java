...
public class LabelRecord extends UpdatableRecordImpl<LabelRecord> implements TableRecordJaxb, Label {
    ...
    public Map<String,Object> getData() {
        return get(LabelTable.LABEL.DATA);
    }
    ...
    public Record1<Long> key() {
        return super.key().into(LabelTable.LABEL.ID);
    }
     ...
     */
    public LabelRecord() {
        super(LabelTable.LABEL);
    }

    /**
     * Create a detached, initialised LabelRecord
     */
    public LabelRecord(Long id, String name, Long accountId, String kind, String uuid, String description, String state, Date created, Date removed, Date removeTime, Map<String,Object> data, String type, String key, String value) {
        super(LabelTable.LABEL);
