...
public class Token {
    ...
    private List<String> federatedAuthenticationMethods;
    private String federatedAuthenticationContext;
    private Long federatedAuthenticatedAt;
    private String federatedAuthenticationIssuer;
    ...
    @Field(nullable = true)
    public List<String> getFederatedAuthenticationMethods() {
        return federatedAuthenticationMethods;
    }

    public void setFederatedAuthenticationMethods(List<String> federatedAuthenticationMethods) {
        this.federatedAuthenticationMethods = federatedAuthenticationMethods;
    }

    @Field(nullable = true)
    public String getFederatedAuthenticationContext() {
        return federatedAuthenticationContext;
    }

    public void setFederatedAuthenticationContext(String federatedAuthenticationContext) {
        this.federatedAuthenticationContext = federatedAuthenticationContext;
    }

    @Field(nullable = true)
    public Long getFederatedAuthenticatedAt() {
        return federatedAuthenticatedAt;
    }

    public void setFederatedAuthenticatedAt(Long federatedAuthenticatedAt) {
        this.federatedAuthenticatedAt = federatedAuthenticatedAt;
    }

    @Field(nullable = true)
    public String getFederatedAuthenticationIssuer() {
        return federatedAuthenticationIssuer;
    }

    public void setFederatedAuthenticationIssuer(String federatedAuthenticationIssuer) {
        this.federatedAuthenticationIssuer = federatedAuthenticationIssuer;
    }
}
