...
public class SshKeyGenTest {
    ...
    public void sshRsaTextFormatReadsDynamicConfigThroughWrapper() throws Exception {
        ...
        try {
            ...
            KeyPair pair = SshKeyGen.generateKeyPair();
    ...
    @Test
    public void generatesRsaKeysAtTheSecurityFloor() throws Exception {
        KeyPair pair = SshKeyGen.generateKeyPair();
        assertTrue(((RSAPublicKey) pair.getPublic()).getModulus().bitLength() >= 2048);
    }
